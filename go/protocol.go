// Package minewire implements Minecraft protocol primitives.
// These functions handle encoding and decoding of Minecraft protocol data types
// such as VarInt, String, and packet structures.
package minewire
